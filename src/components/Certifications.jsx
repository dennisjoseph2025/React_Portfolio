...
const Certifications = () => {
    ...
    return (
        <section className="py-16 md:py-24 px-4 md:px-6 bg-[#050505] md:bg-[#0D0D0D] relative z-10 border-t border-white/[0.02]">
            <div id="certifications" className="max-w-6xl mx-auto scroll-mt-[15vh]">
                <SectionReveal>
                    <div className="mb-8 md:mb-10">
                        <h2 className="text-4xl md:text-4xl lg:text-6xl font-black text-white tracking-tighter mb-2 md:mb-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col h-full">
                            <div className="flex items-center gap-2.5 mb-5">
                                ...
                                <h3 className="text-lg font-bold text-white uppercase tracking-tight">Education</h3>
                            </div>
                            <div className="p-6 bg-neutral-900/30 border border-neutral-800 rounded-2xl hover:border-neutral-700 transition-colors flex-1">
                                <h4 className="text-lg font-bold text-white mb-1.5">Bachelor of Commerce – Computer Applications</h4>
                                <p className="text-white/60 mb-1.5 text-sm">Mahatma Gandhi University (MGU), Kottayam</p>
                                <span className="text-xs text-white/30 font-mono">2022 – 2025</span>
                            </div>
                        </motion.div>
                        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="flex flex-col h-full">
                            <div className="flex items-center gap-2.5 mb-5">
                                <Award className="text-white/40" size={20} />
                                <h3 className="text-lg font-bold text-white uppercase tracking-tight">Certification</h3>
                            </div>
                            <div className="p-6 bg-neutral-900/30 border border-neutral-800 rounded-2xl hover:border-neutral-700 transition-colors relative group flex-1">
                                <h4 className="text-lg font-bold text-white mb-1.5">EF SET English Certificate</h4>
                                <p className="text-white/60 mb-3 text-sm">Issued: Nov 2025</p>
                                ...
                                <motion.div className="absolute top-6 right-6 text-white/30 group-hover:text-white transition-colors" whileHover={{ scale: 1.1 }}>
